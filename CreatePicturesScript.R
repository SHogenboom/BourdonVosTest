...
# write a loop to change colors with a maximum of 3/4/5 black dots per figure
rndcolors <- c("black") #for testing purposes

##### PLOT THE DATAPOINTS #####

plot(dat[,2]~dat[,1], type="p", xlab = "", ylab = "", xlim=c(0,4), ylim=c(0,4), cex = 2, frame.plot=FALSE, asp = 1, lwd = 2,
     axes = FALSE, pch = 21, bg = rndcolors)
